           ...
           <div class="container">
            <form wire:submit.prevent='save'>
                 <div class="alert alert-primary" role="alert">
                    <h4 class="alert-heading">Ecole liée à cette filiere </h4>
                  ...
                  <div class="row">
                      <div class="col-md-12">
                              <div class="form-group">
                                <label>School Name to link</label>
                                <input type="text" class="form-control "  placeholder="Ex. Ecole polyvalente" value='{{ $model}}' disabled>
                              </div> 
                      </div>
                  </div>
