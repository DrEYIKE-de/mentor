      ...
      <div class="col-md-8">
        <div class="card card-user">
          ...
          <div class="card-header">
            <h5 class="card-title">1- Profil de l'Ecole</h5>
          </div>
          ...
          <div class="card-body">
           ...
           <form enctype="multipart/form-data" wire:submit.prevent='save'>
              ...
              <div class="row">
                  <div class="col">
                      <p class="text-dark">Nom de l'Ecole</p>
                  </div>
              </div>
              ...
              <div class="row">
                <div class="pr-1 col-md-10">
                  ...
                  @enderror">
                    ...
                    form-control-danger 
                    @enderror" placeholder="Ex. Ecole Nationale Superieure" wire:model='name' name="name" value="{{ old('name') }}">
                  </div>
              ...
              <div class="row">
                  <div class="col">
                      <p class="text-dark">Photos de l'Ecole</p>
                  </div>
              </div>
              ...
              <div class="row">
                  <div class="col">
                      <p class="text-dark">Nom du Directeur</p>
                  </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Addresse de l'Ecole</label>
              ...
              <div class="row">
                  <div class="col">
                      <p class="text-dark">Un mot sur l'Ecole</p>
                  </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Description de l'Ecole</label>
            ...
            <div class="card-body">
                <div class="author">
                  <a href="#">
                    ...
                    <h5 class="title">Ecole</h5>
                    {{ $name }}
                  </a>
                </div>
                <hr class="mr-3">
                <h6 class="mb-2 card-subtitle text-muted">directeur : {{ $rector }}</h6>
                <hr class="mr-3">
